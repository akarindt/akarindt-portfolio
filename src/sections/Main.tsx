    ...
    return (
        <div className="w-full min-h-[90vh] sm:h-screen flex flex-col items-center justify-center gap-4 sm:gap-5 py-8">
            ...
            <div className="text-center flex flex-col items-center gap-1 sm:gap-2">
                <h1 className="text-xl sm:text-2xl dark:text-white">Hi, I'm Nong Duc Thang</h1>
                <p className="text-3xl sm:text-4xl md:text-5xl font-bold dark:text-white">
                    Web Developer
                </p>
            </div>
            <div className="flex flex-row flex-wrap justify-center items-center">
                {GENERAL_INFO.map(info => (
                    <div
                        key={uuidv4()}
                        className="flex items-center gap-2 mx-2 sm:mx-3 my-1 text-base sm:text-lg dark:text-gray-300"
                    >
                        <info.icon />
